...
const Details = () => {
    return ( 
        <div className="w-full text-black flex flex-col items-center gap-12 p-8 sm:flex-row sm:w-3/5">
            <div className="flex flex-col items-center gap-4">
                <div className="relative w-32 h-32 rounded-full overflow-hidden">
                    <img className="w-full h-full object-cover" src="/Images/profile.jpg" alt="Profile" />
                </div>
            ...
            <div className="w-4/5 flex flex-col justify-center gap-4">
